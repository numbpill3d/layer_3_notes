...
function showEncryptionAnimation() {
    ...
    container.className = 'crypto-animation encryption';
    container.innerHTML = `
        <div class="crypto-text">ENCRYPTING DATA</div>
        <div class="crypto-progress"></div>
    `;
...
function showDecryptionAnimation() {
    const container = document.createElement('div');
    container.className = 'crypto-animation decryption';
    container.innerHTML = `
        <div class="crypto-text">DECRYPTING DATA</div>
        <div class="crypto-progress"></div>
    `;
    document.body.appendChild(container);
